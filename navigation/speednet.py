"""
SpeedNet v2 PyTorch Inference Engine for Inertial Dead Reckoning.
Multi-Task Neural Network predicting forward speed, yaw rate, zero-speed probability, and delta_v.
"""
...
class SpeedNetV2(nn.Module):
    ...
    def __init__(self, window_size=40, in_channels=6, hidden_dim=64):
        ...
        # 1. Shared Temporal Feature Extractor (1D CNN)
        ...
        # Head 3: Zero-Speed / Stationary Classification Logits
        ...
        # Head 4: Acceleration Auxiliary Head
...
def load_speednet_v2_model(weights_path='models/speednet_v2_w40.pth', window_size=40, device='cpu'):
    """Helper to instantiate and load SpeedNet v2 weights."""
    dev = torch.device(device)
    model = SpeedNetV2(window_size=window_size).to(dev)
